...
CREATE TABLE Event (
    ...
    FOREIGN KEY (EventTypeID) REFERENCES EvnetType(EventTypeID) ON DELETE SET NULL
...
UPDATE Event SET EventTypeID = 1 WHERE EventID = 1;
UPDATE Event SET EventTypeID = 2 WHERE EventID = 2;
UPDATE Event SET EventTypeID = 3 WHERE EventID = 3;
UPDATE Event SET EventTypeID = 4 WHERE EventID = 4;
UPDATE Event SET EventTypeID = 5 WHERE EventID = 5;
